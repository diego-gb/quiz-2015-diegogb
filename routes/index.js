...
router.get('/logout', 	sessionController.destroy); // destruir sesión <DEBERÍA SER DELETE Y NO GET>
...
router.get('/quizes/statistics', statisticController.obtainData, statisticController.show);
